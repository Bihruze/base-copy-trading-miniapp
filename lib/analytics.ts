// Mock date functions
const format = (date: Date, formatStr: string) => date.toISOString().split('T')[0]
...
const subMonths = (date: Date, months: number) => new Date(date.getTime() - months * 30 * 24 * 60 * 60 * 1000)
